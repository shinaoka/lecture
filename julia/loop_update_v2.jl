...
function reflect_spins_on_loop!(loop_length::Int64,
         ...
         for i in 1:Int(loop_length/2)
             perpendicular_vec += collect(spins[spins_on_loop[2i]] - spins[spins_on_loop[2i-1]])
         end
         ...
         for i in 1:loop_length
             ...
             new_spins_on_loop[i] = Tuple(normalize(spin_old - 2 * dot(spin_old,noemal_vec) * normal_vec))
         end
end
